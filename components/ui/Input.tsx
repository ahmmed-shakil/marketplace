...
const inputClass =
  "w-full rounded-md border border-[#ced0d4] bg-white px-3 py-2 text-[15px] text-[#050505] placeholder:text-[#65676b] outline-none transition-all focus:border-primary focus:ring-1 focus:ring-primary";
