      ...
      <div className="bg-primary py-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-4 text-center lg:flex-row lg:text-left lg:px-6">
          <div>
            ...
            <p className="mt-2 text-white/75">Join 100+ vendors reaching thousands of buyers across Bangladesh.</p>
          </div>
          <Link href="/vendor-signup">
            <Button size="lg" className="bg-white text-primary hover:bg-[#f0f2f5] shadow-lg">
              Get Started Free
            </Button>
          </Link>
        </div>
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:grid-cols-2 lg:grid-cols-5 lg:px-6">
        <div className="lg:col-span-2">
          ...
          <div className="mt-4 flex gap-3">
            {socialLinks.map(({ Icon, label }) => (
              <a key={label} href="#" aria-label={label} className="flex h-9 w-9 items-center justify-center rounded-full bg-[#f0f2f5] text-primary hover:bg-accent-light">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2.5 text-[15px] text-[#65676b]">
            {[
              ...
              <li key={href}><Link href={href} className="text-primary hover:underline">{label}</Link></li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-3 text-[15px] text-[#65676b]">
            <li className="flex items-center gap-2"><MapPin className="h-4 w-4 shrink-0 text-primary" /> Dhaka, Bangladesh</li>
            <li className="flex items-center gap-2"><Phone className="h-4 w-4 shrink-0 text-primary" /> +880 1XXX-XXXXXX</li>
            <li className="flex items-center gap-2"><Mail className="h-4 w-4 shrink-0 text-primary" /> hello@market.bd</li>
          </ul>
        </div>
      </div>
